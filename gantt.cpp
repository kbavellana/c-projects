...
void process(int p);
//void gantt(int start, int finish);
struct Jobs_desc
{
	bool skip;
	int Arrival;
...
int jobb,last_arrival,Total_burst,small_burst,f_job=0,many=0,timeline=0,storage[10],Time_start,Time_finish,idle=0,gant[20];
	int i,j,k,x,y,t,temp,pass; float TAve,WAve;
